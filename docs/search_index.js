...

{
    ...
    "category": "Method",
    "text": "calculate_auc(ya, yb)\n\nThis function takes two DataArrays ya and yb and calculates variance of predicted AUC,   logit of predicted AUC, and variance of logit of predicted AUC responses passed.\n\n\n\n"
},
...

{
    ...
    "category": "Method",
    "text": "simulate_one_predictor(iter, m, p)\n\nIt asks for number of iterations to be run, number of observations in treatment   and control groups for the simulation of Semiparametric AUC regression adjusting for one discrete   covariate. In this simulation, true model parameters are as follows: β0 = 0.15, β1 = 0.50, β2 = 1.\n\n\n\n"
},

{
    ...
    "category": "section",
    "text": "calculate_auc(ya, yb)semiparametricAUC(model_formula, treatment_group, data)calculate_auc_simulation(ya, yb)simulate_one_predictor(;iter = 500, m = 100, p = 120)"
},
